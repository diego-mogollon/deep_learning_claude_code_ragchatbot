...
class CourseOutlineTool(Tool):
    ...
    def get_tool_definition(self) -> Dict[str, Any]:
        return {
            ...
            "description": "Get the full outline for a course: title, course link, and complete list of lessons with their numbers and titles. Use this for questions about what a course covers, its structure, or lesson listings.",
            "input_schema": {
                "type": "object",
                "properties": {
                    "course_name": {
